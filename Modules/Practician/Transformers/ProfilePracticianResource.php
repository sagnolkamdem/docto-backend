...
class ProfilePracticianResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'commune' => $this->addresses->pluck('commune')??null,
            ...
            'motifs' => $this->motifs,
            'availabilities' => [
                'practician_id' => $this->id,
                'time_slots' => [
                    'payload' => ((new \Modules\Appointment\Http\Controllers\Api\AppointmentController)->values($this->availableSlots()))
                ]
            ],
            'agenda' => [
                'practician_id' => $this->id,
                'time_slots' => [
                    'payload' => ((new \Modules\Appointment\Http\Controllers\Api\AppointmentController)->values($this->unavailableSlots()))
                ]
            ],
        ];
    }
