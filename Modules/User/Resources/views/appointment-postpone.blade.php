            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Rendez-vous ajouné</h1>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Cher {{ $user->first_name  }}, Tabiblib vous informe que votre rendez-vous medical du {{ $old->timeSlot->payload['date'] }} a {{ $old->timeSlot->payload['start_time'] }} a été renvoyé au {{ $appointment->timeSlot->payload['date'] }} a {{ $appointment->timeSlot->payload['start_time'] }}</p>
                        <p style="margin: 0;">Veuillez contacter votre medecin pour plus d'info.</p>
                    </td>
                </tr>
                <!-- end copy -->
